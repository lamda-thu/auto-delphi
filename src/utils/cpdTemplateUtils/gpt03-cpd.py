...
if __name__ == "__main__":
    ...
    loadTemplate(
        template_value_range,
        input_dir=os.path.join("data", "gpt-03-electricVehicleMarketing", "electricVehicleMarketing-base"),
        output_base_dir=os.path.join("data", "gpt-03-electricVehicleMarketing", "electricVehicleMarketing-cpd")
    )