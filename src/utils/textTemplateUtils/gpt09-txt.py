...
if __name__ == "__main__":
    ...
    template_value_range = {
        "#productivity#": [0, 0.1, 0.2],
        "#cost#": [0, 0.1, 0.2],
        "#demand#": [0, 0.1, 0.2]
    }
    loadTemplate(
        template_value_range,
        input_dir=os.path.join("data", "gpt-09-productDevelopment", "productDevelopment-base"),
        output_base_dir=os.path.join("data", "gpt-09-productDevelopment", "productDevelopment-cpd")
    )