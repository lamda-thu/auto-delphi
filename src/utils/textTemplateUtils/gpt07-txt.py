...
if __name__ == "__main__":
    ...
    template_value_range = {
        "#quality#": [0, 0.1, 0.199999],
        "#environment#": [0, 0.1, 0.199999],
    }
    loadTemplate(
        template_value_range,
        input_dir="data\\gpt-07-recruitment\\recruitment-base",
        output_base_dir="data\\gpt-07-recruitment\\recruitment-cpd"
    )