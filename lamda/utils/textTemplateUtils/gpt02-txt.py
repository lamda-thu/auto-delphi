...
if __name__ == "__main__":
    ...
    loadTemplate(
        template_value_range,
        input_dir=os.path.join("data", "gpt-02-scienceArtSelection", "scienceArtSelection-base"),
        output_base_dir=os.path.join("data", "gpt-02-scienceArtSelection", "scienceArtSelection-cpd")
    )