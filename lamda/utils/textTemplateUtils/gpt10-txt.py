...
if __name__ == "__main__":
    ...
    template_value_range = {
        "#diet_quality#": [0.000001, 0.1, 0.199999],
        "#talent#": [0.000001, 0.05, 0.009999]
    }
    loadTemplate(
        template_value_range,
        input_dir="data\\gpt-10-healthManagement\\healthManagement-base",
        output_base_dir="data\\gpt-10-healthManagement\\healthManagement-cpd"
    )