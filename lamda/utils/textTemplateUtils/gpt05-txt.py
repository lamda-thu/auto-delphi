...
if __name__ == "__main__":
    ...
    template_value_range = {
        "#weather_condition#": [0, 0.1, 0.199999],
        "#city_level#": [0, 0.1, 0.199999],
    }
    loadTemplate(
        template_value_range,
        input_dir="data\\gpt-05-trafficManagement\\trafficManagement-base",
        output_base_dir="data\\gpt-05-trafficManagement\\trafficManagement-cpd"
    )