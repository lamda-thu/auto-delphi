...
if __name__ == "__main__":
    ...
    template_value_range = {
        "#difficulty#": [0, 0.1, 0.199999],
        "#health#": [0, 0.1, 0.199999],
        "#ability#": [0, 0.1, 0.199999],
    }
    loadTemplate(
        template_value_range,
        input_dir="data\\gpt-06-examPreparation\\examPreparation-base",
        output_base_dir="data\\gpt-06-examPreparation\\examPreparation-cpd"
    )